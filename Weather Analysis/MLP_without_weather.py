...
def predict_function(trial, X_train, X_test, y_train, y_test, test_dates, file):
    ...
    if file == "concelho_metropolitana_lisboa.csv":
        # Hidden Layer 0
        model.add(Dense(8, activation=activation_layer, input_dim=X_train.shape[1]))
        # Hidden Layer 1
...
if __name__ == "__main__":
    ...
    if file =="concelho_metropolitana_lisboa.csv":
        storage_url = "sqlite:///MLP_lisboa_sem.sqlite3"
    else:
        storage_url = "sqlite:///MLP_porto_sem.sqlite3"
